...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class RoomSharingServer : MonoBehaviour
    {
        ...
        /// </summary>
        public Dictionary<int, XPAnchor> m_RoomAnchorsDict = new Dictionary<int, XPAnchor>();

        public void onclick()
        {
            Debug.Log(m_RoomAnchorsDict);
            foreach (KeyValuePair<int, XPAnchor> kvp in m_RoomAnchorsDict)
            {
